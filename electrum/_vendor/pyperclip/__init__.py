...
def init_no_clipboard():
    if not hasattr(init_no_clipboard, "_clipboard_class"):
        class ClipboardUnavailable(object):
            ...
            if PY2:
                ...
                def __bool__(self):
                    return False
        init_no_clipboard._clipboard_class = ClipboardUnavailable

    ClipboardUnavailable = init_no_clipboard._clipboard_class
